...
func init() {
	...
	beego.GlobalControllerRouter["github.com/daystram/cast/cast-be/controller/v1:AuthController"] = append(beego.GlobalControllerRouter["github.com/daystram/cast/cast-be/controller/v1:AuthController"],
