      ...
      <Container fluid style={style.content_container}>
        ...
        {this.state.key ? (
          <>
            {this.state.error_verify && (
              <Alert variant={"danger"}>
                ...
                <p>
                  Your verification link is invalid! Please request for a new
                ...
                <div className="d-flex justify-content-end">
                  <Button
                    onClick={() => {
                      this.setState({ key: "", error_verify: "" });
            ...
            {this.state.success && (
              <Alert variant="success">
                ...
                <p>
                  ...
                  start sharing videos and stream live!
                </p>
                <hr />
                <div className="d-flex justify-content-end">
                  <Button
          ...
          <>
            ...
            {this.state.error_verify && (
              <Alert variant={"danger"}>{this.state.error_verify}</Alert>
            )}
            {this.state.success && (
              <Alert variant={"success"}>Verification link sent!</Alert>
            )}
            {this.state.verified && (
              <Alert variant="success">
                <Alert.Heading>Welcome!</Alert.Heading>
