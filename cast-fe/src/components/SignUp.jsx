  ...
  validate(field, value) {
    ...
    switch (field) {
      ...
      case "username":
        ...
        if (value.trim().length < 4) {
          this.setState({
            error_username: "Username must be at least 4 alphanumerics",
          });
          return false;
        }
        ...
        if (!usernameRe.test(value.trim())) {
          this.setState({
            error_username: "Username must only contain alphanumerics",
          });
          return false;
        }
  ...
  submitForm(e) {
    ...
    axios
      ...
      .catch((error) => {
        console.log(error);
        this.setState({
          error_signup: "An error has occurred!",
          loading: false,
        });
      });
  }
        ...
        <Container fluid style={style.content_container}>
          ...
          {this.state.success && (
            <Alert variant="success">
              ...
              <p>
                Your account has been successfully registered! Check your email
                to verify your email before logging in.
              </p>
            </Alert>
          )}
          {this.state.error_signup && (
            <Alert variant={"danger"}>{this.state.error_signup}</Alert>
          )}
          <Form noValidate onSubmit={this.submitForm}>
            ...
            <Form.Group>
              <Form.Row>
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    ...
                    onChange={this.handleChange}
                    type={"password"}
                    isInvalid={!!this.state.error_password}
                  />
                  <Form.Control.Feedback type={"invalid"}>
                ...
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    ...
                    onChange={this.handleChange}
                    type={"password"}
                    isInvalid={!!this.state.error_password2}
                  />
                  <Form.Control.Feedback type={"invalid"}>
              ...
              <ProgressBar
                variant={["danger", "warning", "info", "success"][strength - 1]}
