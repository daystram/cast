  ...
  submitForm(e) {
    ...
    api.cast
      ...
      .catch((error) => {
        console.log(error);
        this.setState({
          error_upload: "An error has occurred! Please try again.",
          uploading: false,
        });
      });
  }
          ...
          <Row>
            ...
            <Col xl={10} sm={12} className={"mid-container-right"}>
              ...
              {this.state.error_upload && (
                <Alert variant={"danger"}>{this.state.error_upload}</Alert>
              )}
              {this.state.success && (
                <Alert
                  variant="success"
                ...
                >
                  ...
                  <p>
                    Your video is now currently being processed and will be
                    available in a few minutes. Video may first appear in lower
                    quality, as higher resolutions are still being ingested.
                  </p>
                </Alert>
              )}
                    ...
                    <Form.Group>
                      ...
                      <div className={"custom-file"}>
                        <Form.Control
                          ...
                          onBlur={this.handleChangeFile}
                          isInvalid={!!this.state.error_thumbnail}
                          disabled={this.state.uploading}
                        />
                        <Form.Control.Feedback type={"invalid"}>
                    ...
                    <Form.Group>
                      ...
                      <div className={"custom-file"}>
                        <Form.Control
                          ...
                          onChange={this.handleChangeFile}
                          onBlur={this.handleChangeFile}
                          isInvalid={!!this.state.error_video}
                          disabled={this.state.uploading}
                        />
                        <Form.Control.Feedback type={"invalid"}>
                          {this.state.error_video}
                        </Form.Control.Feedback>
                        <Form.Label
                          style={{ overflow: "hidden" }}
                          className="custom-file-label"
